...
export default function LoginScreen({ onSwitchToSignup }: Props) {
  ...
  return (
    <LinearGradient colors={["#0a0b1a", "#1a1047"]} style={styles.container}>
      ...
      <Text style={styles.title}>VeaHome</Text>
      <Text style={styles.subtitle}>Sign in to control your home</Text>
      ...
      <TouchableOpacity style={styles.button} onPress={onSubmit} disabled={submitting}>
        <LinearGradient colors={["#5762ff", "#6f3bea"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.buttonGradient}>
          {submitting ? <ActivityIndicator color="#E6E9FF" /> : <Text style={styles.buttonText}>Sign In</Text>}
        </LinearGradient>
      </TouchableOpacity>
      <TouchableOpacity style={styles.demoButton} onPress={loginDemo}>
        <Text style={styles.demoText}>Continue as Demo</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={onSwitchToSignup ?? (() => navigation.navigate('Signup'))}>
